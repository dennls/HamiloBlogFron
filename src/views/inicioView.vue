<template>
    <div class="container p-0">
        <carousel class="carousel" :autoplay="3000" :wrap-around="true">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="d-flex text-white">
                            ...
                            <small class="mr-2"><i class="fa fa-comments"></i>
                                {{ slide.cant_comentarios }} Comentarios</small>
                        </div>
                        <RouterLink :to="'/vermas/' + slide.id"
                            class="nav-item nav-link btn btn-lg btn-outline-light mt-4">Leer Mas</RouterLink>
                    </div>
                </div>
            </slide>
    ...
    <div v-if="loading == false" class="container bg-white pt-5">
        <div v-for="item in post" :key="item.id" class="row blog-item px-3 pb-5">
            <div class="col-md-5">
            ...
            <div class="col-md-7">
                ...
                <div class="d-flex mb-3">
                    ...
                    <small class="mr-2 text-muted"><i class="fa fa-comments"></i> {{ item.cant_comentarios }}
                        Comentarios</small>
                </div>
                <p>
                    {{ item.resumen }}
                ...
                <router-link :to="'/vermas/' + item.id" class="btn btn-link p-0">Leer mas <i
